...
$action = New-ScheduledTaskAction -Execute "powershell.exe" -argument "-File `"C:\Users\champuser\SYS320-01\week7\Schedulued Email Reports\main.ps1`""
...
Write-Host (Get-ScheduledTask | Where-Object { $_.TaskName -ilike "myTask" } | Format-Table | Out-String)
